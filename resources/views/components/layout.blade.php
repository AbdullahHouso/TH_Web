...
<header class="px-6 py-6 bg-gray-800 flex flex-row items-center gap-x-6">
    <div class="">
        <h1 class="text-white font-bold text-lg">TechHub Store</h1>
    </div>
...
<div class="text-xl2 px-4">
    <div class="py-4">
        <h2 class="text-3xl font-bold my-5">{{$title ?? 'Page'}}</h2>
        <hr>
    </div>
    {{ $slot }}
</div>
